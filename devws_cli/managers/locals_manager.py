...
import re # For regex in _get_git_repo_info
...
class LocalsManager:
    ...
    def configure_gcs_sync(self, arg_project_id, arg_bucket_name, profile_name, global_config_dict, actual_global_config_file):
        """
    ...
    def get_gcs_profile_config(self, profile_name='default'):
        """
